...
export default function ProductDetailClient() {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen flex flex-col font-sans bg-black text-white">
                <Navbar />
                <main className="grow py-20 md:py-32">
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans bg-black text-white">
            <Navbar />
            <main className="grow py-20 md:py-28">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-zinc-900 rounded-2xl p-6 sm:p-8 lg:p-10 border border-white/5 mb-8">
                        <div className="flex flex-col lg:flex-row lg:items-center gap-8">
                            {/* Image */}
                            <div className="relative w-full max-w-[280px] sm:max-w-[350px] lg:max-w-[400px] aspect-square mx-auto lg:mx-0 shrink-0">
                                {!imageLoaded && (
