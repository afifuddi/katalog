            ...
            <main className="flex-grow">
                <div className="bg-gradient-to-b from-zinc-900 to-black text-white pt-32 pb-16 border-b border-white/5">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <span className="text-primary font-bold tracking-widest text-sm uppercase mb-4 block">{t.ourCollection[language]}</span>
                        <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-white">{t.title[language]}</h1>
