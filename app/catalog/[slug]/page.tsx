                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-zinc-900 rounded-2xl p-6 sm:p-8 lg:p-10 border border-white/5 mb-8">
                        <div className="flex flex-col lg:flex-row lg:items-center gap-8">
                            ...
                            <div className="flex-grow text-center lg:text-left">
                                ...
                                {product.variety && (
                                    <p className="text-white/50 text-sm mb-4">Variety: <span className="text-white/70">{product.variety}</span></p>
                                )}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-zinc-900/50 rounded-2xl p-6 border border-white/5">
                            <h2 className="text-lg font-bold text-white mb-4">About This Coffee</h2>
                        ...
                        <div className="bg-zinc-900/50 rounded-2xl p-6 border border-white/5">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                ...
                                <div className="p-4 bg-black/30 rounded-xl">
                                    <span className="block text-[10px] uppercase tracking-widest text-white/40 mb-1">Process</span>
                                    <span className="text-sm font-medium">{product.process}</span>
                                </div>
                                <div className="p-4 bg-black/30 rounded-xl">
                                    <div className="flex items-center gap-1 mb-1">
                                        <Mountain className="h-3 w-3 text-white/40" />
                                        <span className="text-[10px] uppercase tracking-widest text-white/40">Altitude</span>
                                    </div>
                                ...
                                <div className="p-4 bg-black/30 rounded-xl">
                                    <div className="flex items-center gap-1 mb-1">
                                        ...
                                        <span className="text-[10px] uppercase tracking-widest text-white/40">Moisture</span>
                                    </div>
                                ...
                                <div className="p-4 bg-black/30 rounded-xl">
                                    <div className="flex items-center gap-1 mb-1">
                                        ...
                                        <span className="text-[10px] uppercase tracking-widest text-white/40">Defects</span>
                                    </div>
                                    <span className="text-sm font-medium">{product.defects}</span>
                                </div>
                                <div className="p-4 bg-primary/10 rounded-xl border border-primary/20">
                                    <span className="block text-[10px] uppercase tracking-widest text-primary mb-1">SCA Score</span>
                        ...
                        {/* Recommended Uses */}
                        <div className="bg-zinc-900/50 rounded-2xl p-6 border border-white/5">
                            <h2 className="text-lg font-bold text-white mb-4">Recommended Uses</h2>
